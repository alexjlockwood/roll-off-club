...
롤 오프를 플레이하면서 어려운 점 중 하나는 다른 플레이어와의 충돌을 피하면서 경로를 진행하는 것입니다. 다음은 롤 오프 플레이 도중 다른 플레이어와의 충돌 방지를 위한 몇 가지 팁입니다.
...
이를 방지하는 쉬운 방법은 가능한 한 이동 대신 점프를 이용하는 것입니다. 이렇게 하면 충돌이 발생할 가능성이 높은 환승 구간을 안전하게 피할 수 있습니다.

점프가 더 안전한 대안이 되는 몇 가지 예시는 다음과 같습니다.
