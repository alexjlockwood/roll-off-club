...
[壁まし](../rolls/5-waller.md) + [3ジャン](../rolls/closed-open-open-closed.md#blue) は、20パターンのうち最も耐久が難しいと言われています。他プレイヤーとの衝突を避けるために複雑なルート選択をする必要があり、実際に行動するのも難関です。

## ルート

### 7、8周目

7、8周目はフィジカルで負ける可能性があり、かなり危険です。

#### 通常ルート

青で3回ジャンプして、オレンジに移動して3回ジャンプするのが通常ルートです。8周目は非常に狭いので、他のプレイヤーに押し出されないように、青で1つ目の壁までまっすぐ走ってからオレンジに移動することをオススメします。
...
[Syedhsn555][Syed] が考案したとされるルートです。
...
1. 青3回ジャンプでスタート
2. オレンジの2つ目の壁の後ろに移動する
3. オレンジの3つ目の壁の前にジャンプで移動
4. ジャンプで青に戻る
...
[CityLimitsPK][CityLimitsPK] が考案したとされるルートです。
...
[SH3RKH4N][SH3RKH4N] が考案したとされるルートです。
...
[EChanTV][EChanTV] が考案したとされるルートです
...
[dytlgozj][dytlgozj] が考案したとされるルートです
...
* 1人が9、10周目でSyedルート、11、12周目でSherkhanルート
* 1人が9、10周目でEChanルート、11、12周目でSukiルート
