...
[이지 4](../rolls/easy-4.md#orange) + [그랜드 캐니언](../rolls/grand-canyon.md) 변형은 주황색 롤에서 4개의 연속 점프를 이용하는 경로를 통해 그랜드 캐니언의 큰 간격을 피할 수 있기 때문에 그랜드 캐니언 패턴 변형 중 가장 쉬운 변형입니다. 하지만 후반전에 롤을 환승할 수 있는 타이밍이 매우 타이트하기 때문에 주의가 필요합니다.
