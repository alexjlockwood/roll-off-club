...
| Sherkhan's path             | A [path](./variations/5-waller-open-closed.md#sherkhan-path) used to timeout the 5 Waller + Open-Closed variation of Roll Off. Named after [SH3RKH4N][SH3RKH4N]. |
